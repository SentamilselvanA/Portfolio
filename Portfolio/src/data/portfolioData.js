...
const _MILESTONES = [
  ...
  { year: '2024',      title: 'Full Stack Development',         desc: 'Mastered the MERN stack — React, Node.js, Express, MongoDB. Built real-world projects including Skill Gap Analyzer, CodeNova, and Rhythm Dance Academy.',                                icon: '⚡', color: '#fbbf24', side: 'right' },
...
const _PROJECTS = [
  {
    id: 0, name: 'Skill Gap Analyzer', subtitle: 'MERN Stack Career Tool',
    icon: '🧭', color: '#ec4899', size: 120,
    desc: 'Developed a full-stack MERN application that analyzes user skills against industry roles and job descriptions to identify skill gaps and recommend personalized learning roadmaps. Implemented secure JWT authentication, MongoDB-based REST APIs, and a role-based admin dashboard for user management and analytics. Built a responsive React interface using Vite and Tailwind CSS with dark/light theme support.',
    features: ['Skill gap analysis against industry roles', 'Personalized learning roadmaps', 'JWT authentication', 'Role-based admin dashboard', 'User management & analytics', 'Dark/light theme support'],
    tech: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Vite', 'Tailwind CSS'],
  ...
  {
    id: 1, name: 'CodeNova', subtitle: 'Coding Profile Analyzer | MERN Stack',
    icon: '🚀', color: '#8b5cf6', size: 115,
    desc: 'Developed a full-stack web application that analyzes coding profiles from LeetCode, Codeforces, and GitHub, providing interactive dashboards, performance analytics, AI-powered insights, and visual progress tracking. Implemented JWT authentication, responsive UI, dynamic charts, and theme-aware design for an enhanced user experience.',
    features: ['Multi-platform profile analysis (LeetCode, Codeforces, GitHub)', 'Interactive dashboards & performance analytics', 'AI-powered insights', 'Visual progress tracking', 'JWT authentication', 'Dynamic charts & theme-aware design'],
    tech: ['MongoDB', 'Express.js', 'React.js', 'Node.js'],
    challenge: 'Aggregating and normalizing data from multiple coding platforms with different API structures into a unified analytics dashboard.',
    github: 'https://github.com/SentamilselvanA', live: '#',
  },
  {
    id: 2, name: 'Rhythm Dance Academy', subtitle: 'Dance School Management System | MERN Stack',
    icon: '💃', color: '#00f5ff', size: 110,
    desc: 'Developed a full-stack Dance School Management System using the MERN stack, enabling role-based management for Admin, Faculty, and Students through dedicated dashboards. Implemented secure JWT authentication, RESTful APIs, class enrollment, application tracking, analytics, image uploads, and role-based notifications with responsive UI and robust backend security.',
    features: ['Role-based dashboards (Admin, Faculty, Student)', 'Class enrollment & application tracking', 'JWT authentication & backend security', 'RESTful APIs', 'Image uploads', 'Role-based notifications & analytics'],
    tech: ['MongoDB', 'Express.js', 'React.js', 'Node.js'],
    challenge: 'Designing a flexible role-based access control system that cleanly separates Admin, Faculty, and Student permissions across all features.',
    github: 'https://github.com/SentamilselvanA', live: '#',
  },
]
