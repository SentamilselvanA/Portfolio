...
function merge(ov) {
  const coding = ov.coding || D_CODING
  const internship = ov.internship || D_INTERNSHIP
  return {
    ...
    coding: {
      quick:     Array.isArray(coding.quick)     ? coding.quick     : D_CODING.quick,
      platforms: Array.isArray(coding.platforms) ? coding.platforms : D_CODING.platforms,
    },
    achievements: ov.achievements || D_ACHIEVEMENTS,
    internship: {
      ...D_INTERNSHIP,
      ...internship,
      learningAreas: Array.isArray(internship.learningAreas)
        ? internship.learningAreas
        : D_INTERNSHIP.learningAreas,
    },
  }
}
