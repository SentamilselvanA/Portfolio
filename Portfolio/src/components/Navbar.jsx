    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <motion.span
              className="block w-5 h-0.5 bg-cyan-400 rounded-full origin-center"
              animate={{ rotate: menuOpen ? 45 : 0, y: menuOpen ? 6 : 0 }}
              transition={{ duration: 0.25 }}
            />
            <motion.span
              className="block w-5 h-0.5 bg-cyan-400 rounded-full"
            ...
            >
              ...
              <div className="flex flex-col gap-2 mt-4">
                ...
                <button
                  ...
                  className="font-mono text-xs px-4 py-2.5 rounded-full border border-cyan-500/30 text-cyan-400 hover:border-cyan-400 transition-all"
                >
